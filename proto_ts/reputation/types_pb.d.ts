...
export class PeerID extends jspb.Message { 
    ...
    setPublicKey(value: Uint8Array | string): PeerID;
...
export class Trust extends jspb.Message { 
    ...
    setPeer(value?: PeerID): Trust;
    getValue(): number;
    setValue(value: number): Trust;
...
export class PeerToPeerTrust extends jspb.Message { 
    ...
    setTrustingPeer(value?: PeerID): PeerToPeerTrust;

    hasTrust(): boolean;
    clearTrust(): void;
    getTrust(): Trust | undefined;
    setTrust(value?: Trust): PeerToPeerTrust;
...
export class GlobalTrust extends jspb.Message { 
    ...
    setVersion(value?: refs_types_pb.Version): GlobalTrust;

    hasBody(): boolean;
    clearBody(): void;
    getBody(): GlobalTrust.Body | undefined;
    setBody(value?: GlobalTrust.Body): GlobalTrust;

    hasSignature(): boolean;
    clearSignature(): void;
    getSignature(): refs_types_pb.Signature | undefined;
    setSignature(value?: refs_types_pb.Signature): GlobalTrust;
...
export namespace GlobalTrust {
    ...
    export class Body extends jspb.Message { 
        ...
        setManager(value?: PeerID): Body;

        hasTrust(): boolean;
        clearTrust(): void;
        getTrust(): Trust | undefined;
        setTrust(value?: Trust): Body;
