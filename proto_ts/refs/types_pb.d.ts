...
export class Address extends jspb.Message { 
    ...
    setContainerId(value?: ContainerID): Address;

    hasObjectId(): boolean;
    clearObjectId(): void;
    getObjectId(): ObjectID | undefined;
    setObjectId(value?: ObjectID): Address;
...
export class ObjectID extends jspb.Message { 
    ...
    setValue(value: Uint8Array | string): ObjectID;
...
export class ContainerID extends jspb.Message { 
    ...
    getValue_asU8(): Uint8Array;
    getValue_asB64(): string;
    setValue(value: Uint8Array | string): ContainerID;
...
export class OwnerID extends jspb.Message { 
    ...
    getValue_asU8(): Uint8Array;
    getValue_asB64(): string;
    setValue(value: Uint8Array | string): OwnerID;
...
export class Signature extends jspb.Message { 
    ...
    getKey_asB64(): string;
    setKey(value: Uint8Array | string): Signature;
    getSign(): Uint8Array | string;
    getSign_asU8(): Uint8Array;
    getSign_asB64(): string;
    setSign(value: Uint8Array | string): Signature;
...
export class Checksum extends jspb.Message { 
    ...
    setType(value: ChecksumType): Checksum;
    getSum(): Uint8Array | string;
    getSum_asU8(): Uint8Array;
    getSum_asB64(): string;
    setSum(value: Uint8Array | string): Checksum;
