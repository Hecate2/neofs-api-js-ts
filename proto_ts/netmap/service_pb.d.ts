...
export class LocalNodeInfoRequest extends jspb.Message { 
    ...
    setBody(value?: LocalNodeInfoRequest.Body): LocalNodeInfoRequest;

    hasMetaHeader(): boolean;
    clearMetaHeader(): void;
    getMetaHeader(): session_types_pb.RequestMetaHeader | undefined;
    setMetaHeader(value?: session_types_pb.RequestMetaHeader): LocalNodeInfoRequest;

    hasVerifyHeader(): boolean;
    clearVerifyHeader(): void;
    getVerifyHeader(): session_types_pb.RequestVerificationHeader | undefined;
    setVerifyHeader(value?: session_types_pb.RequestVerificationHeader): LocalNodeInfoRequest;
...
export class LocalNodeInfoResponse extends jspb.Message { 
    ...
    setBody(value?: LocalNodeInfoResponse.Body): LocalNodeInfoResponse;

    hasMetaHeader(): boolean;
    clearMetaHeader(): void;
    getMetaHeader(): session_types_pb.ResponseMetaHeader | undefined;
    setMetaHeader(value?: session_types_pb.ResponseMetaHeader): LocalNodeInfoResponse;

    hasVerifyHeader(): boolean;
    clearVerifyHeader(): void;
    getVerifyHeader(): session_types_pb.ResponseVerificationHeader | undefined;
    setVerifyHeader(value?: session_types_pb.ResponseVerificationHeader): LocalNodeInfoResponse;
...
export namespace LocalNodeInfoResponse {
    ...
    export class Body extends jspb.Message { 
        ...
        setVersion(value?: refs_types_pb.Version): Body;

        hasNodeInfo(): boolean;
        clearNodeInfo(): void;
        getNodeInfo(): netmap_types_pb.NodeInfo | undefined;
        setNodeInfo(value?: netmap_types_pb.NodeInfo): Body;
...
export class NetworkInfoRequest extends jspb.Message { 
    ...
    setBody(value?: NetworkInfoRequest.Body): NetworkInfoRequest;

    hasMetaHeader(): boolean;
    clearMetaHeader(): void;
    getMetaHeader(): session_types_pb.RequestMetaHeader | undefined;
    setMetaHeader(value?: session_types_pb.RequestMetaHeader): NetworkInfoRequest;

    hasVerifyHeader(): boolean;
    clearVerifyHeader(): void;
    getVerifyHeader(): session_types_pb.RequestVerificationHeader | undefined;
    setVerifyHeader(value?: session_types_pb.RequestVerificationHeader): NetworkInfoRequest;
...
export class NetworkInfoResponse extends jspb.Message { 
    ...
    setBody(value?: NetworkInfoResponse.Body): NetworkInfoResponse;

    hasMetaHeader(): boolean;
    clearMetaHeader(): void;
    getMetaHeader(): session_types_pb.ResponseMetaHeader | undefined;
    setMetaHeader(value?: session_types_pb.ResponseMetaHeader): NetworkInfoResponse;

    hasVerifyHeader(): boolean;
    clearVerifyHeader(): void;
    getVerifyHeader(): session_types_pb.ResponseVerificationHeader | undefined;
    setVerifyHeader(value?: session_types_pb.ResponseVerificationHeader): NetworkInfoResponse;
...
export namespace NetworkInfoResponse {
    ...
    export class Body extends jspb.Message { 
        ...
        setNetworkInfo(value?: netmap_types_pb.NetworkInfo): Body;
