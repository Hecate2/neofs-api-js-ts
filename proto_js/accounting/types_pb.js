 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.neo.fs.v2.accounting.Decimal.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getValue();
  if (f !== 0) {
    writer.writeInt64(
 ...
 * @return {!proto.neo.fs.v2.accounting.Decimal} The clone.
 */
proto.neo.fs.v2.accounting.Decimal.prototype.cloneMessage = function() {
  return /** @type {!proto.neo.fs.v2.accounting.Decimal} */ (jspb.Message.cloneMessage(this));
};
