 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.neo.fs.v2.accounting.BalanceRequest.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getBody();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {!proto.neo.fs.v2.accounting.BalanceRequest} The clone.
 */
proto.neo.fs.v2.accounting.BalanceRequest.prototype.cloneMessage = function() {
  return /** @type {!proto.neo.fs.v2.accounting.BalanceRequest} */ (jspb.Message.cloneMessage(this));
};
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.neo.fs.v2.accounting.BalanceRequest.Body.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getOwnerId();
  if (f != null) {
    writer.writeMessage(
...
/**
 * Creates a deep clone of this proto. No data is shared with the original.
 * @return {!proto.neo.fs.v2.accounting.BalanceRequest.Body} The clone.
 */
proto.neo.fs.v2.accounting.BalanceRequest.Body.prototype.cloneMessage = function() {
  return /** @type {!proto.neo.fs.v2.accounting.BalanceRequest.Body} */ (jspb.Message.cloneMessage(this));
};
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.neo.fs.v2.accounting.BalanceResponse.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getBody();
  if (f != null) {
    writer.writeMessage(
...
/**
 * Creates a deep clone of this proto. No data is shared with the original.
 * @return {!proto.neo.fs.v2.accounting.BalanceResponse} The clone.
 */
proto.neo.fs.v2.accounting.BalanceResponse.prototype.cloneMessage = function() {
  return /** @type {!proto.neo.fs.v2.accounting.BalanceResponse} */ (jspb.Message.cloneMessage(this));
};
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.neo.fs.v2.accounting.BalanceResponse.Body.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getBalance();
  if (f != null) {
    writer.writeMessage(
...
/**
 * Creates a deep clone of this proto. No data is shared with the original.
 * @return {!proto.neo.fs.v2.accounting.BalanceResponse.Body} The clone.
 */
proto.neo.fs.v2.accounting.BalanceResponse.Body.prototype.cloneMessage = function() {
  return /** @type {!proto.neo.fs.v2.accounting.BalanceResponse.Body} */ (jspb.Message.cloneMessage(this));
};
