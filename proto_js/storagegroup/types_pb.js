...
proto.neo.fs.v2.storagegroup.StorageGroup.toObject = function(includeInstance, msg) {
  var f, obj = {
    validationDataSize: msg.getValidationDataSize(),
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.neo.fs.v2.storagegroup.StorageGroup.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getValidationDataSize();
  if (f !== 0) {
    writer.writeUint64(
      1,
      f
 ...
 * @return {!proto.neo.fs.v2.storagegroup.StorageGroup} The clone.
 */
proto.neo.fs.v2.storagegroup.StorageGroup.prototype.cloneMessage = function() {
  return /** @type {!proto.neo.fs.v2.storagegroup.StorageGroup} */ (jspb.Message.cloneMessage(this));
};
